...
directory = 'C:/Users/peng/Desktop/Zillow/input_data/'
train = pd.read_csv(directory+'train_2017.csv')
...
GP_2017=pd.concat([GP1(test),GP2(test),GP3(test),GP4(test),GP5(test)],axis=1)
GP_2017.to_csv('C:/Users/peng/Desktop/Zillow/temporary_data/GP2017.csv',index=False)
